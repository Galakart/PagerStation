...
_**Какие пейджеры поддерживаются?**_
...
Даже в случае применения маломощного передатчика Raspberry Pi, при постоянном вещании ваши действия могут не понравиться контрольным органам. 
