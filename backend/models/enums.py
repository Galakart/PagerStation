...
class GroupTypeEnum(IntEnum):
    ...
    COMMON = 1
    ALERT = 2  # групповое сообщение с громким оповещением, независимо от настроек пейджера
...
class MaildropTypeEnum(IntEnum):
    ...
    # Значит у нас могут быть максимум 16 ячеек (8, если мы используем личный и групповой капкод)
