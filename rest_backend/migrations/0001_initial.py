    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('freq', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(120000000), django.core.validators.MaxValueValidator(999999999)], verbose_name='Частота (Гц)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_create', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('is_sent', models.BooleanField(default=False)),
                ('pager', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='rest_backend.pager', verbose_name='Пейджер-получатель')),
            ],
        ),
        migrations.AddField(
            model_name='pager',
            name='transmitter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='rest_backend.transmitter', verbose_name='Трансмиттер'),
        ),
        migrations.CreateModel(
            name='NewsChannel',
            fields=[
